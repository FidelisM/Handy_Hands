                        ...
                        <Col md={12}>
                            <FormGroup>
                                ...
                                <Input type="text" name="name" id="name" placeholder="Last, First MI."
                                       onChange={handleInputChange.bind(this)} value={this.props.data.name}/>
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                        <Col md={6}>
                            <FormGroup>
                                <Label className="title" htmlFor="date">Date of Birth</Label>
                                <Input type="date" name="date" id="date" placeholder="D.O.B"
                                       onChange={handleInputChange.bind(this)} value={this.props.data.date}/>
                            </FormGroup>
                        </Col>
                        <Col md={6}>
                            <FormGroup>
                                ...
                                }} onChange={handleInputChange.bind(this)} value={this.props.data.soc}/>
                            </FormGroup>
                        </Col>
                    </Row>
                    <FormGroup>
                        ...
                        <Input type="text" name="address" id="address" placeholder="1234 Main St."
                               onChange={handleInputChange.bind(this)} value={this.props.data.address}/>
                    </FormGroup>
                    <Row form>
                        <Col md={6}>
                            <FormGroup>
                        ...
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="telephone" id="telephone"
                                       onChange={handleInputChange.bind(this)} value={this.props.data.telephone} required/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="telephone" id="mobile"
                                       onChange={handleInputChange.bind(this)} value={this.props.data.mobile}/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input type="date" name="employment_date" id="employment_date"
                                       onChange={handleInputChange.bind(this)} value={this.props.data.employment_date}/>
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                            ...
                            <FormGroup className="text-end">
                                ...
                                <label htmlFor="travel_yes">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="travel" id="travel_yes"
                                           type="radio" value="Yes" checked={this.props.data.travel_yes} required/> Yes
                                </label>
                                <label htmlFor="travel_no">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="travel" id="travel_no"
                                           type="radio" value="No" checked={this.props.data.travel_no}/> No
                                </label>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup className="text-end">
                                ...
                                <label htmlFor="sponsor_yes">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="sponsor" id="sponsor_yes"
                                           type="radio" value="Yes" checked={this.props.data.sponsor_yes} required/> Yes
                                </label>
                                <label htmlFor="sponsor_neg">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="sponsor" id="sponsor_neg"
                                           type="radio" value="No" checked={this.props.data.sponsor_neg} required/> No
                                </label>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup className="text-end">
                                ...
                                <label htmlFor="clearance_yes">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="clearance"
                                           ...
                                           checked={this.props.data.clearance_yes}
                                           required/> Yes
                                </label>
                                <label htmlFor="clearance_no">
                                    <input onChange={handleRadioButtonChange.bind(this)} name="clearance"
                                           id="clearance_no" type="radio" value="No"
                                           checked={this.props.data.clearance_no}/> No
                                </label>
                            </FormGroup>
                        </Col>
                    </Row>

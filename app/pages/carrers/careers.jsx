        ...
        return (
            <div className="container careers" id="main">
                <article id="content">
                    <header>
                        <h2>Careers</h2>
                        <p>Your family’s partner in providing quality home healthcare; love and compassion live here.</p>
                    </header>
                    ...
                    <p className="title"> Qualifications & Requirements </p>
                        <ul>
                            ...
                            <li>Be able to provide a minimum of three
                                ...
                                health agencies/facilities and private duty.</li>
